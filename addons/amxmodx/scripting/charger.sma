...
public menuRemove( id, iMenu )
{
    ...
    formatex( szItem, charsmax( szItem ), "%L", id, "CHARGER_DEL_CURRENT" )
    menu_additem( iMenu, szItem )
...
public chargerRemove( eCharger[ CHARGER ], iIndex )
{
    ...
    ArrayDeleteItem( g_aCharger, iIndex )
    g_iCharger--
}
